...
Sources checked the morning of 31 August 2026. Numbers move; this is a snapshot, not a wire service.
...
3. **DRC Ebola** → **Cat 3**  
   Still the active high-burden outbreak. Uganda’s separate outbreak was declared over on 28 August after 42 days with no new confirmed case — that close-out is the positive counterweight, not a reason to drop DRC.
...
- Indonesia wildfires / regional haze: Japanese ship JS Kunisaki dispatched to help; wildlife rescues in West Kalimantan. Dry-season file, weeks old.
- Middletown NJ flooding (27 August): cars trapped on Rts 35/36; pockets of Belford under water; local outages. Recovery, not a new event today.
...
- Energy-price and shipping knock-on if Hormuz stays tight (Venezuela oil deal announced as a U.S. reserve hedge).
- West Nile virus in Monmouth mosquitoes — spraying already done 20 and 27 August; watch late-summer human cases.

**Top Surfacing PUF**

- **Politics**: SCO summit opens in Bishkek; U.S.–Iran strike/counter-strike cycle; U.S.–Venezuela oil-control announcement.
...
- **Understanding**: Himalayan flood as climate + steep terrain + hydropower siting, not a one-day weather story; Hormuz as household fuel and food-price risk far from the strike points.
...
- **Forgotten Conflicts**: Sudan (still the largest single-country humanitarian caseload, ~33 million in need, little daily airtime); Myanmar civil war; Sahel / Mali (prisoner exchange reported, the war is not over); South Sudan relapse risk.
...
Nepal toll and missing counts kept climbing into the 31 August desks. The Hormuz file moved from “background war” to a named U.S. strike on Larak and an Iranian reply. Uganda’s Ebola close-out is now a confirmed end, which splits that health story in two.

**Signal vs Noise note**

Signal is concentrated: one catastrophic flood, one energy-chokepoint war, one remaining Ebola theatre. Everything else is either a continuation or a local aftershock.
